...
*/	
	    ...
	    if(systemInfo != null && systemInfo.getBlockingAlgorithmName() != null && systemInfo.getBlockingAlgorithmName().contains("Traditional Blocking Algorithm") ) {
	    	menuItemBlocking = new MenuItem("Blocking Configuration", IconHelper.create("images/bricks.png"), new SelectionListener<MenuEvent>() {
		    	@Override
		    	public void componentSelected(MenuEvent ce) {
	    ...
	    if(systemInfo != null && systemInfo.getMatchingAlgorithmName().contains("Deterministic Matching Algorithm") ) {
	    	menuItemMatching = new MenuItem("Matching Configuration", IconHelper.create("images/wrench_orange.png"), new SelectionListener<MenuEvent>() {
		    	@Override
		    	public void componentSelected(MenuEvent ce) {
        ...
        configMenuOptions.add(menuItemJobQueue);
        ...
        advancedSubmenu.add(menuClearLoggedLinks);
