...
//		metadata.add(new AttributeMetadata("languageCd", DataProfileAttribute.STRING_DATA_TYPE));
		...
		metadata.add(new AttributeMetadata("motherName", DataProfileAttribute.STRING_DATA_TYPE));
		metadata.add(new AttributeMetadata("fatherName", DataProfileAttribute.STRING_DATA_TYPE));
...
//		metadata.add(new AttributeMetadata("nationalityCd", DataProfileAttribute.STRING_DATA_TYPE));
		...
		metadata.add(new AttributeMetadata("phoneNumber", DataProfileAttribute.STRING_DATA_TYPE));
